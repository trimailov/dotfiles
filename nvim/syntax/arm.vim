...
"ARM
syn keyword armRegister	R9 R10 R11 R12 R13 R14 R15 SP sp LR lr PC pc SPSR CPSR CPSR_c CPSR_cxsf BP bp
...
syn keyword armInstr		ADD ADDHI ADDC SUBB SUBHI INC DEV MUL DIV MOV MOVHI MOVC MOVX PUSH POP XCH XCHD LSL
...
syn keyword armInstr		ADC ADD AND B BIC BKPT BL BLX BX BXJ BHI CDP CDP2 CLZ CMN CMP CPS CPY CMPLS
